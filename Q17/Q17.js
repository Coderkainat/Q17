...
var GuestArr = ["Hiba Bukhari", "Hina Altaf", "Hamza Abbasi"];
var canNotAttend = "Hina Altaf";
var newGuest = "Fatima Effendi";
GuestArr[GuestArr.indexOf(canNotAttend)] = newGuest;
GuestArr.unshift("kainat Bilal");
var middleGuest = "Shagufta Ejaz";
var middleIndex = GuestArr.length / 2;
GuestArr.splice(middleIndex, 0, middleGuest);
GuestArr.push("Mishal");
